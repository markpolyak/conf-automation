...
### TODO
- [ ] Изучить существующие бесплатные решения для организации конференций, составить перечень достоинств и недостатков для каждого
- [ ] Изучить существующие бесплатные решения для сбора (подачи) статей для публикации, составить перечень достоинств и недостатков для каждого
- [ ] Написать скрипт на Google Script для внесения данных во внутреннюю гугл-таблицу при заполнении формы "Заявка на участие" (пункт 2 в рабочем процессе)
- [ ] Написать скрипт на Google Script для формирования программы конференции в виде документа в Google Docs (пункт 4 в рабочем процессе)
- [ ] Написать скрипт на Python 3.6 (или выше) с использованием Google Sheets API для формирования программы конференции в виде документа MS Word (файл в формате docx) (пункт 4 в рабочем процессе)
...
- [ ] Написать скрипт на Google Script для формирования отчета о заседаниях в виде документа в Google Docs (пункт 6 в рабочем процессе)
- [ ] Написать скрипт на Python 3.6 (или выше) с использованием Google Sheets API для формирования отчета о заседаниях в виде документа MS Word (файл в формате docx) (пункт 6 в рабочем процессе)
      - Учесть ограничение бесплатной версии Google Sheets API на количество запросов в единицу времени, сделав в скрипте соответствующие задержки
      - Скрипт запускается вручную из командной строки
- [ ] Написать скрипт на Google Script для внесения данных во внутреннюю гугл-таблицу при заполнении формы для подачи статьи для публикации (пункт 8 в рабочем процессе)
- [ ] Написать скрипт на Google Script для формирования списка представляемых к публикации докладов (статей) в виде документа в Google Docs (пункт 9 в рабочем процессе)
- [ ] Написать скрипт на Python 3.6 (или выше) с использованием Google Sheets API для формирования списка представляемых к публикации докладов в виде документа MS Word (файл в формате docx) (пункт 9 в рабочем процессе)
      - Учесть ограничение бесплатной версии Google Sheets API на количество запросов в единицу времени, сделав в скрипте соответствующие задержки
      - Скрипт запускается вручную из командной строки
